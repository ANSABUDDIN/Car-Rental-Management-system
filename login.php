            ...
            <div class="row " style=" display:flex;align-items:center;">
                ...
                <div class="col-md-9 col-sm-2 col-xs-2 pd-right-0 padding__0">
                    <div class="site-logo site-logo-3 " style="padding:0px">
                        <a href="index.php">
                            <img src="assets/images/logo2.png" class="logo" alt="logo" /></a>
                    </div>
        ...
        <div class="container-fluid h-custom">
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-md-9 col-lg-6 col-xl-5 justify-content-center d-flex">
                    <img src="assets/images/pickup/car01.png" class=" login-img" alt="Sample image">
                </div>
                    ...
                    <form action="login_db.php" method="post">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="form-check mb-0">
                                <!-- <input class="form-check-input me-2" type="checkbox" require value="" id="form2Example3" />
                        ...
                        <div class="text-center text-lg-start mt-4 pt-2">
                            <button type="submit" class=" login-btn btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;">Login</button>
