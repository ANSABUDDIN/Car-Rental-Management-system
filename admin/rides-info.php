                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a target="_blank" href="../car-single-page.php?car=<?php echo $getuser['car_id']?>">
                                                <?php echo $getuser['car_name'];  ?>
                                            </a>
                                        </td>
                                        <td><?php echo $getuser['pickup_Location'];  ?> </td>
                                        <td><?php echo $getuser['dropoff_Location'];  ?> </td>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="my-3 text-start">
                                                                <label class="fw-600 fs-6">Vendor Number</label>
                                                                <!-- <input type="text" class="text-start form-control" disabled value=""
                                                                > -->
                                                                <div class="form-control">
                                                                    <?php
                                                                    $sql = mysqli_query($con, "select * from users
                                                                where id='$vendor_id'");
                                                                    foreach ($sql as $getresult) {
                                                                        $phone_number_v = $getresult['phonenum'];
                                                                        echo $phone_number_v;
                                                                    }
                                                            ...
                                                            <div class="my-3 text-start">
                                                                <label class="fw-600 fs-6">User Number</label>
                                                                ...
                                                                where id='$user_id'");
                                                                    foreach ($sql as $getresult) {
                                                                        $phone_number_u = $getresult['phonenum'];
                                                                        echo $phone_number_u;
                                                                    }
                                                            ...
                                                            <div class="my-3 text-start">
                                                                <label class="fw-600 fs-6">Pickup Date</label>
                                                                <input type="text" class="form-control" disabled value="<?php echo $getuser['pickup_Date'];  ?>">
                                                            </div>
                                                            <div class="my-3 text-start">
                                                                <label class="fw-600 fs-6">Dropoff Date</label>
                                                                <input type="text" class="form-control" disabled value="<?php echo $getuser['dropoff_Date'];  ?>">
                                                            </div>
                                                            <div class="my-3 text-start">
                                                                <label class="fw-600 fs-6">Pickup Time</label>
                                                                <input type="text" class="form-control" disabled value="<?php echo $getuser['pickup_Time'];  ?>">
                                                            </div>
                                                            <div class="my-3 text-start">
                                                                <label class="fw-600 fs-6">Drop Off Time</label>
                                                                <input type="text" class="form-control" disabled value="<?php echo $getuser['dropoff_Time'];  ?>">
                                                            </div>
