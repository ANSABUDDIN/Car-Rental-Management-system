                        ...
                        <div class="float-end">
                            ...
                            <div class="dropdown d-inline-block">
                                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    if ($_SESSION['vendor']['profile_img'] == "") {
                                    ?>
                                    ...
                                    ?>
                                        <img class="rounded-circle avtar-sm header-profile-user" src="<?php echo $_SESSION['vendor']['profile_img']; ?>" alt="Header Avatar">
                                    <?php
                                    }
                                    ?>
                                    <span class="d-none d-xl-inline-block ms-1"><?php echo $_SESSION['vendor']['email']; ?></span>
                ...
                <div class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="carlist.php" class=" waves-effect">
                            ...
                            <li>
                                <a href="booked-car.php" class=" waves-effect">
                                    <i class="mdi mdi-cash-multiple"></i>
                                    <span>My Booked Cars</span>
                                </a>
                            </li>
