                            ...
                            <div class="card-body">
                                <div class="profile-widgets py-3">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="mt-3 ">
                                            <a href="#" class="text-dark fw-medium font-size-16"><?php echo $_SESSION['vendor']['username']; ?></a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class=""><?php echo $_SESSION['vendor']['email']; ?></h6>
                                </div>

                                <div class="mt-3">
                                    <p class="font-size-12 text-muted mb-1">Phone number</p>
                                    <h6 class=""><?php echo $_SESSION['vendor']['phonenum']; ?></h6>
                                </div>

                                <div class="mt-3">
                                    <p class="font-size-12 text-muted mb-1">Office Address</p>
                                    <h6 class=""> <?php echo $_SESSION['vendor']['address']; ?>
                                    </h6>
                                </div>
                    ...
                    <div class="col-md-12 col-xl-9">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-12 text-center">
                                                <p class="mb-2">Rides Completed</p>
                                                <h4 class="mb-0 text-primary">3,524</h4>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-12 text-center">
                                                ...
                                                <h4 class="mb-0 text-success">$5,362</h4>
                                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="hidden" name="user-id" value="<?php echo $_SESSION['vendor']['id']; ?>" id="useremail" placeholder="Enter email">
